...
if __name__ == "__main__":
    ...
    query='SELECT name, metacritic, released, added_status_owned AS owned, added_status_playing AS playing FROM games WHERE metacritic is NOT NULL AND metacritic > 75 ORDER BY metacritic DESC'
